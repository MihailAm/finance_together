...
Revision ID: 50530bc96d30
Revises: 
Create Date: 2024-12-30 17:52:36.390931
...
def upgrade() -> None:
    ...
    op.create_table('accounts',
                    ...
                    sa.Column('user_id', sa.Integer(), nullable=True, default=None),
    ...
    op.create_table('planned_expenses',
                    ...
                    sa.Column('type', sa.Enum('INCOME', 'EXPENSE', name='plannedexpensetype'), nullable=False),
                    sa.Column('group_id', sa.Integer(), nullable=True),
                    sa.Column('user_id', sa.Integer(), nullable=True),
                    sa.Column('category_id', sa.Integer(), nullable=False),
                    sa.ForeignKeyConstraint(['category_id'], ['categories.id'], ),
